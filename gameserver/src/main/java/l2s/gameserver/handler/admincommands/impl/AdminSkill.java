	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch(command)
		{
			...
			case admin_buff:
				...
				activeChar.sendPacket(new SkillListPacket(activeChar), new AcquireSkillListPacket(activeChar));
				break;
		}
	...
	private void removeAllSkills(Player activeChar)
	{
		...
		for(Skill skill : skills)
		{
			if(skill != null)
			{
				...
				player.sendPacket(new SkillListPacket(player), new AcquireSkillListPacket(player));
			}
		}
