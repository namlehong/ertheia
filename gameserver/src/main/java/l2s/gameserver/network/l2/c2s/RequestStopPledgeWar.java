...
public class RequestStopPledgeWar extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendPacket(SystemMsg.YOU_ARE_NOT_AUTHORIZED_TO_DO_THAT, ActionFailPacket.STATIC);
			return;
		}
		...
		{
			//activeChar.sendPacket(SystemMsg.YOU_HAVE_NOT_DECLARED_A_CLAN_WAR_AGAINST_THE_CLAN_S1, ActionFailPacket.STATIC); [TODO] FIX this S1 incorect method.
			return;
		}
		...
		for(UnitMember mbr : playerClan)
			...
			{
				activeChar.sendPacket(SystemMsg.A_CEASEFIRE_DURING_A_CLAN_WAR_CAN_NOT_BE_CALLED_WHILE_MEMBERS_OF_YOUR_CLAN_ARE_ENGAGED_IN_BATTLE, ActionFailPacket.STATIC);
				return;
			}
