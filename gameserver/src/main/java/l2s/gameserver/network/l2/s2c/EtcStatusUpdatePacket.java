...
public class EtcStatusUpdatePacket extends L2GameServerPacket
{
	...
	private int armorExpertisePenalty, weaponExpertisePenalty, CharmOfCourage, ConsumedSouls;
	...
	protected final void writeImpl()
	{
		...
		writeD(0); //Death Penalty max lvl 15, "Combat ability is decreased due to death."
