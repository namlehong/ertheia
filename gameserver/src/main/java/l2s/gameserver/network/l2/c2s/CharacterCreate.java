...
public class CharacterCreate extends L2GameClientPacket
{
	...
	private void initNewChar(GameClient client, Player newChar)
	{
		...
		newChar.rewardSkills(false, false, false, false);
		...
		if(newChar.getSkillLevel(7029) > 0) // Super Haste
			newChar.registerShortCut(new ShortCut(11, 0, ShortCut.TYPE_SKILL, 7029, 1, 1));
