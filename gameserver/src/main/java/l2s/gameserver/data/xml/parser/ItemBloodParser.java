 ...
 */
public final class ItemBloodParser extends StatParser<ItemHolder>
{
	private static final ItemBloodParser _instance = new ItemBloodParser();

	public static ItemBloodParser getInstance()
	{
		return _instance;
	}

	protected ItemBloodParser()
	{
	...
	{
		return new File(Config.DATAPACK_ROOT, "data/blood_items/");
	}
