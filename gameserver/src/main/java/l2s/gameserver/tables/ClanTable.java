...
public class ClanTable
{
	...
	public void dissolveClan(Player player)
	{
		...
		for(Player clanMember : clan.getOnlineMembers(0))
		{
			...
			clanMember.sendPacket(PledgeShowMemberListDeleteAllPacket.STATIC, SystemMsg.YOU_HAVE_RECENTLY_BEEN_DISMISSED_FROM_A_CLAN);
	...
	public void startClanWar(Clan clan1, Clan clan2)
	{
		...
		clan1.broadcastToOnlineMembers(new SystemMessagePacket(SystemMsg.YOU_HAVE_DECLARED_A_CLAN_WAR_WITH_S1_CLAN_WAR_STARTS_IN_3_DAYS).addString(clan2.getName()));
		clan2.broadcastToOnlineMembers(new SystemMessagePacket(SystemMsg.S1_HAS_DECLARED_A_CLAN_WAR_CLAN_WAR_STARTS_IN_3_DAYS).addString(clan1.getName()));
	}
	...
	public void stopClanWar(Clan clan1, Clan clan2)
	{
		...
		clan1.broadcastToOnlineMembers(new SystemMessagePacket(SystemMsg.THE_WAR_AGAINST_S1_CLAN_HAS_BEEN_STOPPED).addString(clan2.getName()));
		clan2.broadcastToOnlineMembers(new SystemMessagePacket(SystemMsg.THE_CLAN_S1_HAS_DECIDED_TO_STOP_THE_WAR).addString(clan1.getName()));
	}
