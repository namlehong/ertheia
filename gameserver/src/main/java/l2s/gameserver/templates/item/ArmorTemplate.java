...
public final class ArmorTemplate extends ItemTemplate
{
	...
	public ArmorTemplate(StatsSet set)
	{
		...
		{
			_type1 = TYPE1_OTHER;
			_type2 = TYPE2_ACCESSORY; // TODO: Check this.
		}
		else
		{
		...
		if(_bodyPart == ItemTemplate.SLOT_HEAD)
		...
		else if(_bodyPart == ItemTemplate.SLOT_R_FINGER || _bodyPart == ItemTemplate.SLOT_L_FINGER)
			_exType = ExItemType.RING;
		else if(_bodyPart == ItemTemplate.SLOT_R_EAR || _bodyPart == ItemTemplate.SLOT_L_EAR)
