...
public class PetData
{
	...
	private final List<CapsuledItem> _expirationRewardItems = new ArrayList<CapsuledItem>();
	...
	public void addExpirationRewardItem(CapsuledItem item)
	{
		_expirationRewardItems.add(item);
	}

	public CapsuledItem[] getExpirationRewardItems()
	{
		return _expirationRewardItems.toArray(new CapsuledItem[_expirationRewardItems.size()]);
	}
}