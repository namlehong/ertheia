...
public class CharStatsChangeRecorder<T extends Creature>
{
	...
	public static final int SEND_ABNORMAL_INFO = 1 << 3; // Требуется обновить статус HP/MP/CP
	...
	protected void refreshStats()
	{
		...
		_visualTransformId = set(SEND_ABNORMAL_INFO, _visualTransformId, _activeChar.getVisualTransformId());
