 ...
 */
public final class NpcGaiHolder extends AbstractHolder
{
	private static final NpcGaiHolder _instance = new NpcGaiHolder();
	...
	public static NpcGaiHolder getInstance()
	{
		return _instance;
	}
