...
public class OnActionShift extends Functions
{
	public boolean OnActionShift_NpcInstance(Player player, GameObject object)
	{
		...
		if(object.isNpc())
		{
			...
			if(Config.ALT_FULL_NPC_STATS_PAGE)
			{
				...
				dialog = dialog.replaceFirst("%pevs%", String.valueOf(npc.getPEvasionRate(null)));
				dialog = dialog.replaceFirst("%pacc%", String.valueOf(npc.getPAccuracy()));
				dialog = dialog.replaceFirst("%mevs%", String.valueOf(npc.getMEvasionRate(null)));
				dialog = dialog.replaceFirst("%macc%", String.valueOf(npc.getMAccuracy()));
				dialog = dialog.replaceFirst("%pcrt%", String.valueOf(npc.getPCriticalHit(null)));
				dialog = dialog.replaceFirst("%mcrt%", String.valueOf(npc.getMCriticalHit(null, null)));
			...
			dialog = dialog.replaceFirst("<?npc_name?>", nameNpc(npc));
			dialog = dialog.replaceFirst("%id%", String.valueOf(npc.getNpcId()));
	...
	public void stats()
	{
		...
		dialog = dialog.replaceFirst("%pAtk%", String.valueOf(npc.getPAtk(null)));
		dialog = dialog.replaceFirst("%mAtk%", String.valueOf(npc.getMAtk(null, null)));
		dialog = dialog.replaceFirst("%paccuracy%", String.valueOf(npc.getPAccuracy()));
		dialog = dialog.replaceFirst("%pevasionRate%", String.valueOf(npc.getPEvasionRate(null)));
		dialog = dialog.replaceFirst("%pcriticalHit%", String.valueOf(npc.getPCriticalHit(null)));
		dialog = dialog.replaceFirst("%maccuracy%", String.valueOf(npc.getMAccuracy()));
		dialog = dialog.replaceFirst("%mevasionRate%", String.valueOf(npc.getMEvasionRate(null)));
		dialog = dialog.replaceFirst("%mcriticalHit%", String.valueOf(npc.getMCriticalHit(null, null)));
		dialog = dialog.replaceFirst("%runSpeed%", String.valueOf(npc.getRunSpeed()));
		dialog = dialog.replaceFirst("%walkSpeed%", String.valueOf(npc.getWalkSpeed()));
	...
	public boolean OnActionShift_PetInstance(Player player, GameObject object)
	{
		...
		if(object.isPet())
		{
			...
			dialog = dialog.replaceFirst("<?npc_name?>", HtmlUtils.htmlNpcName(pet.getNpcId()));
			...
			dialog = dialog.replaceFirst("%paccuracy%", String.valueOf(pet.getPAccuracy()));
			dialog = dialog.replaceFirst("%pevasionRate%", String.valueOf(pet.getPEvasionRate(null)));
			dialog = dialog.replaceFirst("%pcrt%", String.valueOf(pet.getPCriticalHit(null)));
			dialog = dialog.replaceFirst("%maccuracy%", String.valueOf(pet.getMAccuracy()));
			dialog = dialog.replaceFirst("%mevasionRate%", String.valueOf(pet.getMEvasionRate(null)));
			dialog = dialog.replaceFirst("%mcrt%", String.valueOf(pet.getMCriticalHit(null, null)));
	...
	public boolean OnActionShift_ItemInstance(Player player, GameObject object)
	{
		...
		if(object.isItem())
		{
			...
			dialog = dialog.replaceFirst("<?npc_name?>", String.valueOf(item.getTemplate().getName()));
			...
			dialog = dialog.replaceFirst("%grade%", String.valueOf(item.getGrade()));
