...
{
	//TODO Glory: 900 Обломков Доспехов (34991), 500 Самоцветов для Аксессуаров (34992)
	int SPINNERET = 7528;
	//int SUEDE = 1866;
	//int THREAD = 1868;
	int PART_ARM = 34991;
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equals("30165-3.htm") && cond == 5)
		{
			...
			if(st.getQuestItemsCount(GEM_FOR_ACC) >= 500 && st.getQuestItemsCount(PART_ARM) >= 900 && st.getQuestItemsCount(SPIDERSILK) == 1)
			{
				st.takeItems(GEM_FOR_ACC, 500);
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == 30088)
		{
			...
			else if(cond == 6 && (st.getQuestItemsCount(GEM_FOR_ACC) < 500 || st.getQuestItemsCount(PART_ARM) < 900 || st.getQuestItemsCount(SPIDERSILK) < 1))
				htmltext = "30088-havent.htm";
			else if(cond == 6)
