...
public class _10769_LettersFromTheQueenCrumaTowerPart1 extends Quest implements ScriptFile, OnPlayerEnterListener, OnLevelChangeListener
{
	...
	private static String NEXT_LETTER_STRING = "Hãy cố gắng ở đây và tập luyện tới level 46.\nNữ Hoàng Navari sẽ gửi bức thư tiếp theo";
	...
	public _10769_LettersFromTheQueenCrumaTowerPart1()
	{
		...
		if(Config.DEFAULT_LANG != Language.VIETNAMESE)
		{
			...
			NEXT_LETTER_STRING = "Stay here and train until level 46.\nQueen Navari will send you next letter";
		}
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.giveItems(STEEL_DOOR_COIN, 11, true);
			st.giveItems(SCROLL_EWC, 1, true);
			st.giveItems(SCROLL_EAC, 1, true);
