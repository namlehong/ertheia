		...
		switch(itemId)
		{
			...
			case 20393:
				for(int skill : sweet_list)
				{
					...
					player.altOnMagicUse(player, SkillTable.getInstance().getInfo(skill, 1));
				}
				break;
			// Fresh Fruit Cocktail				
			case 10179:
			...
			case 14739:
				...
				player.altOnMagicUse(player, SkillTable.getInstance().getInfo(2891, 6));
			...
			case 33862:
				for(int skill_id : ELIXIR_OF_BLESSING_LIST)
				{
					...
					player.altOnMagicUse(player, SkillTable.getInstance().getInfo(skill_id, 1));
				}
				break;
			case 35991:
